...
data_hash['addresses'].each do |address|  
  ...
  lead = Lead.create(
      ...
      project_name: Faker::Lorem.word.gsub(/[()-]/, ""),
      project_description: Faker::Lorem.paragraph.gsub(/[()-]/, ""),
      dept_in_charge_of_elevators: Faker::Job.field.gsub(/[()-]/, ""), #commercial, residential ..&
      message: Faker::Lorem.paragraph.gsub(/[()-]/, ""),
      attached_file: Faker::File.mime_type.gsub(/[()-]/, ""),
